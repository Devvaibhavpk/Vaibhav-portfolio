...
const socials = [
  ...
  { icon: Mail, href: `mailto:${socialLinks.email}`, label: "Email", isLucide: true },
];
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <p className="text-text-secondary text-sm flex items-center gap-1.5 justify-center md:justify-start">
              ...
              <Heart size={14} className="text-gold fill-gold" /> by{" "}
              <span className="text-gold font-semibold">Vaibhav P K</span>
            </p>
            ...
            {socials.map((social) => {
              ...
              return (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="p-2.5 rounded-lg bg-surface-light text-text-secondary hover:text-gold hover:bg-gold/10 transition-all duration-300"
                >
                  {social.isLucide ? (
                    <Mail size={18} />
                  ) : (
